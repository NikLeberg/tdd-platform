...
#define MEM_COUNTING_SEMAPHORE      SemaphoreHandle_t
...
#define MEM_SEMAPHORE_TAKE(SemaphoreHandle_t, xBlockTime)                             \
	xSemaphoreTake(SemaphoreHandle_t, xBlockTime)

/* Wrapper for giving a counting semaphore */
#define MEM_SEMAPHORE_GIVE(SemaphoreHandle_t)                                         \
	xSemaphoreGive(SemaphoreHandle_t)

/* Wrapper for taking a counting semaphore out of an ISR */
#define MEM_SEMAPHORE_TAKE_ISR(SemaphoreHandle_t, pxTaskWoken)                        \
    xQueueReceiveFromISR((QueueHandle_t) (SemaphoreHandle_t), NULL, pxTaskWoken)

/* Wrapper for giving a counting semaphore out of an ISR */
#define MEM_SEMAPHORE_GIVE_ISR(SemaphoreHandle_t, pxTaskWoken)                        \
    xSemaphoreGiveFromISR(SemaphoreHandle_t, pxTaskWoken)
